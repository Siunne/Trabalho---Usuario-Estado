...
function validarCampos() {
    ...
    if ($('#nome').val().trim() === '') {
        ...
        Swal.fire({
            position: 'center',
            icon: 'error',
            title: 'Verifique o nome do usuario!',
            ...
            if (data == 1) {
                ...
                Swal.fire({
                    ...
                    window.location.href =
                            '${pageContext.request.contextPath}/UsuarioListar';
                });
                ...
                Swal.fire({
                    position: 'center',
                    icon: 'error',
                    title: 'Dados em branco ou nao informados!',
                    showConfirmButton: true,
                    timer: 5000
                ...
                Swal.fire({
                    position: 'center',
                    icon: 'error',
                    title: 'Nao foi possivel gravar o usuario!',
                    showConfirmButton: true,
                    timer: 5000
